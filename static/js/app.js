...
function outputResult(result) {
  ...
  resultMessageElement.innerHTML = `Saya pikir ini adalah <b>${result.label}</b> dengan `;
  resultMessageElement.innerHTML += `<b>${result.percentage}%</b> akurasi.`;
  // speak(`Saya pikir ini adalah ${result.label} dengan tingkat akurasi ${result.percentage}%.`);
}
